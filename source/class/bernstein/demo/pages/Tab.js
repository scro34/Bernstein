...
qx.Class.define("bernstein.demo.pages.Tab",
{
  ...
  members:
  {
    ...
    {
      var page1 = new qx.ui.tabview.Page("Layout", "@fontawesome/f1fc/14").set({showCloseButton: true});
      page1.setLayout(new qx.ui.layout.VBox());
      page1.add(new qx.ui.basic.Label("Layout-Settings…"));
      tabView.add(page1);

      var page2 = new qx.ui.tabview.Page("Notes", "@fontawesome/f249/14").set({showCloseButton: true});
      page2.setLayout(new qx.ui.layout.VBox());
      page2.add(new qx.ui.basic.Label("Notes…"));
      tabView.add(page2);

      var page3 = new qx.ui.tabview.Page("Calculator", "@fontawesome/f1ec/14").set({showCloseButton: true});
