...
qx.Class.define("bernstein.demo.pages.ToolBar",
{
  ...
  members:
  {
    ...
    getToolBar : function()
    {
      ...
      // SplitButton
      var splitButton = new qx.ui.toolbar.SplitButton("Toolbar SplitButton", "@fontawesome/f0a8/14", this.getSplitButtonMenu());
      splitButton.setToolTip(new qx.ui.tooltip.ToolTip("Toolbar SplitButton"));
      this._widgets.push(splitButton);

      // Button
      var button = new qx.ui.toolbar.Button("Toolbar Button", "@fontawesome/f15b/14");
      button.setToolTip(new qx.ui.tooltip.ToolTip("Toolbar Button"));
      this._widgets.push(button);

      // CheckBox
      var checkBox = new qx.ui.toolbar.CheckBox("Toggle", "@fontawesome/f0cd/14");
      checkBox.setToolTip(new qx.ui.tooltip.ToolTip("Toolbar CheckBox"));
      this._widgets.push(checkBox);

      // RadioButton
      var radioButton1 = new qx.ui.toolbar.RadioButton("Left", "@fontawesome/f036/14");
      radioButton1.setToolTip(new qx.ui.tooltip.ToolTip("Toolbar RadioButton"));
      this._widgets.push(radioButton1);

      var radioButton2 = new qx.ui.toolbar.RadioButton("Center", "@fontawesome/f037/14");
    ...
    getButtonMenu : function()
    {
      ...
      // MenuButton
      var button = new qx.ui.menu.Button("Menu MenuButton", "@fontawesome/f15b/14");
      this._widgets.push(button);
