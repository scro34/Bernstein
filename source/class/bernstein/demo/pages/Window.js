...
qx.Class.define("bernstein.demo.pages.Window",
{
  extend: bernstein.demo.pages.AbstractPage,
  ...
  members:
  {
    ...
    initWidgets: function()
    {
      ...
      widgets.push(w1);
      w1.open();
      this.__desktop.add(w1, {left: 10, top: 10});

      w2 = this.__createWindow2();
      widgets.push(w2);
      w2.open();
      this.__desktop.add(w2, {left: 320, top: 100});

      w3 = this.__createWindow3();
      widgets.push(w3);
      w3.open();
      this.__desktop.add(w3, {left: 80, top: 250});
    },

    __createWindow1: function()
    {
      // Create the Window
      var win = new qx.ui.window.Window("First Window", "@fontawesome/f073/16");
      ...
      // Add an Atom
      var atom = new qx.ui.basic.Atom("Welcome to your first own Window.<br/>Have fun!", "@fontawesome/f2b9/32").set({gap: 12});
      atom.setRich(true);
      win.add(atom);
    ...
    {
      var win = new qx.ui.window.Window("Second Window", "@fontawesome/f143/16");
      win.setLayout(new qx.ui.layout.VBox(10));
      win.setStatus("Application is ready");

      var atom = new qx.ui.basic.Atom("The second window", "@fontawesome/f1ec/22").set({gap: 10});
      win.add(atom);
    ...
    {
      var win = new qx.ui.window.Window("Third Window", "@fontawesome/f87b/16");
      ...
      var btn1 = new qx.ui.form.Button("Open Modal Dialog 1", "@fontawesome/f073/14");
    ...
    {
      var wm1 = new qx.ui.window.Window("First Modal Dialog").set({width: 200});
      ...
      var btn2 = new qx.ui.form.Button("Open Modal Dialog 2", "@fontawesome/f073/14");
    ...
    __getModalWindow2: function()
    {
      ...
      var warn1 = new qx.ui.basic.Atom("Do you want to fly to Berlin?", "@fontawesome/f071/20").set({gap: 8});
      wm2.add(warn1);
      ...
      var btn3 = new qx.ui.form.Button("Yes", "@fontawesome/f00c/14");
      btn3.addListener("execute", function(e) {
        wm2.close();
      });
      box.add(btn3);

      var btn4 = new qx.ui.form.Button("No", "@fontawesome/f00d/14");
