 ...
 *
 *
 * @asset(bernstein/demo/fo_tester.swf)
 * @asset(bernstein/demo/blank.html)
 */

qx.Class.define("bernstein.demo.pages.Embed",
{
  ...
  members:
  {
    ...
    initWidgets: function()
    {
      ...
      var flash = new qx.ui.embed.Flash("bernstein/demo/fo_tester.swf").set({
        scale: "noscale",
        width: 100,
        height: 200,
        variables : flashVars
