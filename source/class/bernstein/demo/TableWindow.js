...
qx.Class.define("bernstein.demo.TableWindow",
{
  ...
  members:
  {
    ...
    createTable: function()
    {
      ...
      tcm.setHeaderCellRenderer(2, new qx.ui.table.headerrenderer.Icon("@fontawesome/f073/14", "A date"));
    ...
    createToolbar: function()
    {
      ...
      button = new qx.ui.toolbar.Button("Change row with ID 10", "@fontawesome/f2ea/14");
      ...
      button = new qx.ui.toolbar.Button("Add 10 rows", "@fontawesome/f067/14");
      button.addListener("execute", function(evt) {
      ...
      button = new qx.ui.toolbar.Button("Remove 5 rows", "@fontawesome/f068/14");
      button.addListener("execute", function(evt) {
      ...
      button = new qx.ui.toolbar.Button("Show selection", "@fontawesome/f05a/14");
      button.addListener("execute", function(evt)
      {
        var selection = [];
