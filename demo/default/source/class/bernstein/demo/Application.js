  ...
  members:
  {
    ...
    onAudioPlayerWindow: function(e)
    {
      ...
      this.dockButtonClick(button, this.audioPlayerWindow, function()
      {
        if (!that.audioPlayerWindow) {
          that.audioPlayerWindow = new bernstein.demo.PlayerWindow();
    ...
    onOpenHomepage: function(e)
    {
      if (!this.homePageWindow) {
        this.homePageWindow = new bernstein.demo.WebBrowser();
    ...
    onOpenWikipedia: function(e)
    {
      if (!this.wikipediaWindow) {
        this.wikipediaWindow = new bernstein.demo.WebBrowser();
    ...
    {
      if (!this.videoWindow) {
        this.videoWindow = new bernstein.demo.VideoWindow();
