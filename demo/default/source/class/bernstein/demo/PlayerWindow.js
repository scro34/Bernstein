...
qx.Class.define("bernstein.demo.PlayerWindow",
{
  ...
  members:
  {
    ...
    {
      this._playlistUrl = qx.util.ResourceManager.getInstance().toUri("bernstein/demo/playlist.json");
    ...
    {
      var volumeIcon = this._volumeIcon = new qx.ui.basic.Image("bernstein/demo/icon/16/nm-signal-50.png").set({enabled: false});
    ...
    _createPlaylist: function()
    {
      ...
      emptyList.add(new bernstein.demo.Separator(80));
    ...
    _createInfoBar: function()
    {
      ...
      var btnWikipedia = this._btnWikipedia = new qx.ui.toolbar.Button(null, "bernstein/demo/icon/16/wikipedia.png").set({
        enabled: false
      });
      ...
      btnWikipedia.addListener("execute", function() {
        this.fireDataEvent("openWikipedia", {
          ...
          icon: "bernstein/demo/icon/16/wikipedia.png"
        });
      }, this);
      
      var btnVideo = this._btnVideo = new qx.ui.toolbar.Button(null, "bernstein/demo/icon/16/youtube.png").set({
        enabled: false
      });
      ...
      btnVideo.addListener("execute", function() {
        this.fireDataEvent("openVideo", {
          ...
          icon: "bernstein/demo/icon/16/youtube.png"
        });
      }, this);
    ...
    _onChangeVolume: function(e)
    {
      ...
      var statusIcon = "bernstein/demo/icon/16/nm-signal-00.png";
      
      switch (true)
      {
        case volume == 100:
          statusIcon = "bernstein/demo/icon/16/nm-signal-100.png";
          break;
          
        case volume >=66:
          statusIcon = "bernstein/demo/icon/16/nm-signal-75.png";
          break;
          
        case volume >= 33:
          statusIcon = "bernstein/demo/icon/16/nm-signal-50.png";
          break;
          
        case volume > 0:          
          statusIcon = "bernstein/demo/icon/16/nm-signal-25.png";
          break;
      }
